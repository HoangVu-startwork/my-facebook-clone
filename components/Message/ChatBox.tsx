...
export function ChatBox({ conv, index, onClose }: any) {
                                ...
                                >
                                    ...
                                    <div className={`flex flex-col max-w-[82%] ${isMe ? "message_conversation_1" : "message_conversation_2"}`}>
                                        ...
                                        <img
                                            src={msg.content}
                                            alt="media"
                                            className="max-h-[35vh] min-w-full rounded-xl object-contain"
                                        />
                                    )} */}
                                        {msg.contentType === "image" && (
                                            <img
                                                src={msg.content}
                                                alt="media"
                                                className="max-h-[35vh] min-w-full rounded-xl object-contain cursor-pointer"
