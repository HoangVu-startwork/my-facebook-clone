        ...
        <div className="flex w-full h-screen">
            ...
            <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
                <div className="max-w-md w-full p-3">
                    <h1 className="text-3xl font-semibold mb-6 text-black text-center">Create a new account</h1>
                    <h1 className="text-sm font-semibold mb-6 text-gray-500 text-center">It's quick and easy.</h1>
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <GenderSelector onSelect={handleGender} />
                            {/* {gender && (
                                <p className="mt-4 text-lg">
                                    Bạn đã chọn: <span className="font-semibold">{gender}</span>
                                </p>
                            )} */}
                        </div>
                        <div>
