...
export default function Page() {
    ...
    // Check nếu còn thiếu ít nhất 1 rule
    const hasError = Object.values(rules).includes(false);
    ...
    //Kiểm tra hiện thị lỗi
    const [error, setError] = useState("");
    // Thực hiện api đăng ký
    ...
    const dateError = dateTouched && (!selectedDate.day || !selectedDate.month || !selectedDate.year);
    const isPhone = phoneTouched && phone.trim() === "";
    const isGenderError = genderTouched && (!gender || gender.trim() === "");
    const isPasswordtouched = passwordTouched && password.trim() === "";
            ...
            <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
                <div className="max-w-md w-full p-3">
                    ...
                    `}
                                />
                                {isError && (
                                    <div className="absolute right-3 mt-0.5 top-1/2 -translate-y-1/2 text-gray-600">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input type="text" id="email" name="email"
                                    ...
                                    className={`mt-1 p-2 w-full border rounded-md border-zinc-800 focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300
                                    ${isEmail ? "border-red-600 input-error error-icon" : "border-gray-300"}
                                `} />
                                {isEmail && (
                                    <div className="absolute right-3 mt-0.5 top-1/2 -translate-y-1/2 text-gray-600">
                                        <div className="w-4 h-4 bg-red-600 text-white flex items-center justify-center rounded-full text-xs cursor-pointer group">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input type="text" id="phone"
                                    ...
                                    className={`mt-1 p-2 w-full border rounded-md border-zinc-800 focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300
                                    ${isPhone ? "border-red-600 input-error error-icon" : "border-gray-300"}
                                `} />
                                {isPhone && (
                                    <div className="absolute right-3 mt-0.5 top-1/2 -translate-y-1/2 text-gray-600">
                                        <div className="w-4 h-4 bg-red-600 text-white flex items-center justify-center rounded-full text-xs cursor-pointer group">
                        ...
                        <div className="relative">
                            ...
                            <GenderSelector onSelect={handleGender} isGenderError={isGenderError} />
                            {isGenderError && (
                                <div className="absolute right-3 mt-2 top-1 -translate-y-1/2 text-gray-600">
                                    <div className="w-4 h-4 bg-red-600 text-white flex items-center justify-center rounded-full text-xs cursor-pointer group">
                                        !
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`mt-1 p-2 w-full border rounded-md border-zinc-800 focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300
                                        ${isPasswordtouched ? "border-red-600 input-error error-icon" : "border-gray-300"}`}
                                />
                                {/* Nút con mắt */}
                                <button
                                    type="button"
                                ...
                                {isPasswordtouched && (
                                    <div className="absolute right-3 top-[-9] -translate-y-1/2 text-gray-600">
                                        <div className="w-4 h-4 bg-red-600 text-white flex items-center justify-center rounded-full text-xs cursor-pointer group">
                                            !
                                            {/* TOOLTIP */}
                            ...
                            {password.length > 0 && hasError && (
                                <div className="mt-3 text-sm text-red-600 space-y-1">
                                    {!rules.length && <p>• Ít nhất 8 ký tự</p>}
                                    {!rules.uppercase && <p>• Có chữ hoa (A–Z)</p>}
                                    {!rules.lowercase && <p>• Có chữ thường (a–z)</p>}
                                    {!rules.number && <p>• Có số (0–9)</p>}
                                    {!rules.special && <p>• Có ký tự đặc biệt (!@#$%^&*)</p>}
                                </div>
                            )}
                        </div>
                        <div>
                            <button onClick={handleSubmit} className="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Sign Up</button>
                        </div>
                    </div>
